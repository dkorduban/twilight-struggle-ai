...
```
results/opus_analysis_YYYYMMDD_HHMMSS_<stub>.md
```
...
- Example: `results/opus_analysis_20260409_183042_us_win_rate.md`
...
- Always save to `results/` so output persists across WSL restarts (never `/tmp`).
