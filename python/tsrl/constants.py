...
BASE_SCALAR_DIM = 32
FRAME_CONTEXT_DIM = 8
SCALAR_DIM = BASE_SCALAR_DIM + FRAME_CONTEXT_DIM
...
class _LazyModelRegistry(dict[str, type]):
    ...
    def _ensure_loaded(self) -> None:
        ...
        from tsrl.policies.model import (
            ...
            TSControlFeatModel,
            TSCountryAllocHeadModel,
            TSCountryAttnFiLMGatedModel,
            TSCountryAttnFiLMModel,
            TSCountryAttnFiLMNormalInitModel,
            TSCountryAttnFiLMNormalInitZeroBetaModel,
            TSCountryAttnFiLMZeroBetaBiasModel,
            TSCountryAttnModel,
        ...
        dict.update(
            self,
            {
                ...
                "country_alloc_head": TSCountryAllocHeadModel,
                ...
                "country_attn_film_gated": TSCountryAttnFiLMGatedModel,
                "country_attn_film_normal_init_zero_beta": TSCountryAttnFiLMNormalInitZeroBetaModel,
